...
public interface Model {
   ...
   */
  void addLamp(int r, int c) throws IOException;
   ...
   */
  void removeLamp(int r, int c) throws IOException;
   ...
   */
  void setActivePuzzleIndex(int index) throws IOException;
  ...
  void resetPuzzle() throws IOException;
